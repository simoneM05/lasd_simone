...
void stestSetString(uint &testnum, uint &testerr)
{
  ...
  try
  {
    ...
    cout << endl
         << "Begin of SetLst<string> Test:" << endl;
...
void testSimpleExercise1B(uint &testnum, uint &testerr)
{
  ...
  cout << endl
       << "Exercise 1B (Simple Test) (Errors/Tests: " << testerr << "/" << testnum << ")" << endl;
}
